  ...
  return (
    <HomeContainer>
      ...
      <p>
        ...
        most beautiful taproom. If you would like to login to check out the draft board features click the login link in
        the footer. username: user and password: user
      </p>
      <h2>Taproom</h2>
      <DetailsDiv>
        <Details>
